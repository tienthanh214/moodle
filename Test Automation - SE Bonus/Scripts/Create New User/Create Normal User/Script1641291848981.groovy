...
WebUI.click(findTestObject('Object Repository/Create New User/Page_Moodle Khu vc qun tr Thnh vin Ti khon _57274d/a_Ty bin'))
...
WebUI.verifyElementText(findTestObject('Page_A Nguyn H s cng khai/h1_A Nguyn'), '')

WebUI.verifyElementText(findTestObject('Object Repository/Create New User/Page_A Nguyn H s cng khai/a_test_1gmail.com'), 
    'test_1@gmail.com')
