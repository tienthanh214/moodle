...
WebUI.click(findTestObject('Object Repository/Page_Nh ca ti/a_SE (9)'))
...
WebUI.setText(findTestObject('Object Repository/Page_Bin son Bi tp/input_Tn bi tp_name (10)'), 'Bài tập văn bản')
