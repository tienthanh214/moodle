...
WebUI.click(findTestObject('View course grade/Page_Kha Nhp mn Cng ngh phn mm/button_Bt ch  chnh sa'))

WebUI.click(findTestObject('View course grade/Page_Kha Nhp mn Cng ngh phn mm/span_Thm hot ng hoc ti nguyn'))

WebUI.click(findTestObject('View course grade/Page_Kha Nhp mn Cng ngh phn mm/div_Thng tin v  Bi hc hot ng_optionicon mt-_6d37dc'))

WebUI.setText(findTestObject('View course grade/Page_Bin son Bi tp/input_Tn bi tp_name'), 'BT1')

WebUI.click(findTestObject('View course grade/Page_Bin son Bi tp/input_Upon activity completion_submitbutton'))

WebUI.click(findTestObject('View course grade/Page_CNPM BT1/span_im s'))
...
WebUI.click(findTestObject('View course grade/Page_im s Xem/button_Tt ch  chnh sa'))

WebUI.verifyElementText(findTestObject('View course grade/Page_im s Xem/span_9,00'), '9,00')
